                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="padding-left: 10px" href="/hrd/penyuratan/edit/{{$u->id}}" class="btn btn-info">Edit</a>
                                <a href="/hrd/penyuratan/destroy/{{$u->id}}"  class="btn btn-danger delete-confirm" role="button">Delete</a>
