...
<form action="/hrd/penyuratan/kirim/post" method="post" >
@csrf

<input type="hidden" name="id" value="{{ $user->id }}">

<label for="inputState">Nama Karyawan yang akan dikirim Peringatan</label>
<input type="text" name="" value="{{ $user->name }}" class="form-control" disabled >

<label for="inputState">deskripsi</label>
<textarea  name="deskripsi"  class="form-control" placeholder="deksripsi" required></textarea>

<label for="inputState">Jumlah Alpha dibulan ini</label>
<input type="number" placeholder="{{ $alpha }}" name="" value="{{ $alpha }}" class="form-control" disabled>
